...
/** @deprecated Use DrawingPlacementSlice instead */
export type DraftPlacementSlice = DrawingPlacementSlice;
/** @deprecated Use DrawingPlacementState instead */
export type DraftPlacementState = DrawingPlacementState;
/** @deprecated Use DrawingPlacementActions instead */
...
/** @deprecated Use initialDrawingPlacementState instead */
...
/** @deprecated Use createDrawingPlacementSlice instead */
